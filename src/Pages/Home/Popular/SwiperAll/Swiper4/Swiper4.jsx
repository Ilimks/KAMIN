           ...
           >
              <SwiperSlide>
                <div className="popular__swiper1__card1">
                   <img className='popular__swiper1__card1__img' src={SwiperIMG1} alt="" />
              ...
              <SwiperSlide>
                <div className="popular__swiper1__card2">
                   <img className='popular__swiper1__card2__img' src={SwiperIMG3} alt="" />
              ...
              <SwiperSlide>
                <div className="popular__swiper1__card3">
                   <img className='popular__swiper1__card3__img' src={SwiperIMG2} alt="" />
              ...
              <SwiperSlide>
                <div className="popular__swiper1__card4">
                   <img className='popular__swiper1__card4__img' src={SwiperIMG4} alt="" />
